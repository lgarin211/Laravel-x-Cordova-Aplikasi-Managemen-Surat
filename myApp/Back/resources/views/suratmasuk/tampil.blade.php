    ...
    <div class="box">
        <div>
            ...
            <div class="text-center">
                <iframe style="width: 100%;height: 100vh;" src="{{URL::to('/')}}/datasuratmasuk/{{$suratmasuk->filemasuk}}" class="rounded" width="900"
                    alt="File Tidak Dapat Ditampilkan Silahkan Klik Download Untuk Melihat"></iframe>
